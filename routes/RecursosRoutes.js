...
const HospitalizadoController = require("../controllers/Recursos/HospitalizadoController.js");
const FuncionarioController = require("../controllers/Recursos/FuncionarioController.js");
const mantenedorController = require('../controllers/Recursos/MantenedorController.js');
const dashboardController = require('../controllers/Recursos/DashboardController.js');
const reportesController = require('../controllers/Recursos/reportesController.js');
